...
console.info('Seal init')
chrome.runtime.onMessage.addListener(
  function (request) {
    if (request.type == "fill") {
      console.info('Seal update textarea value')
...
// function suggestionInitial(isRecursion = false) {
...
//   // TODO显示 suggestion-container
//   const container: HTMLDivElement | null = document.querySelector('#suggestion-container')
//   if (!container) return
//   removeChildNode(container)
//   container.style.visibility = 'visible'
//   // TODO 重新渲染 suggestion
